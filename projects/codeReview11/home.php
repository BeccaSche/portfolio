...
$resPet = mysqli_query($conn, "SELECT * FROM pets WHERE pet_availability = 'yes'");
?>
...
<body>
  ...
  <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active text-danger" href="home.php"><b>All Pets</b></a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-danger" href="general.php">Big and Small</a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-danger" href="seniors.php">Seniors</a>
    </li>
  </ul>
